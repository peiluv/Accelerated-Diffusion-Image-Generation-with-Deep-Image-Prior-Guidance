# pretrain_integrated_ddpm.py (0.5 prior weight)
...
def pretrain_integrated_ddpm_05(args):
    ...
    if args.prior_path:
        ...
        save_path = os.path.join(save_dir, "dip_prior_05.png")
